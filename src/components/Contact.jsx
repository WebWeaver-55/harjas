...
import { Phone, Mail, MapPin, Clock, MessageCircle, Send, Home } from 'lucide-react';
...
export default function Contact() {
  const [formData, setFormData] = useState({
    name: '', phone: '', email: '', hostelPreference: '', roomType: '', message: '',
  });
  ...
  return (
    <section id="contact" className="section-padding bg-teal-primary relative overflow-hidden">
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-white/60 mb-6 max-w-lg mx-auto">
            Come see the hostel in person — no commitment needed. We&apos;d love to show you around!
          </p>
        ...
        >
          ...
          <p className="text-white/50 text-lg max-w-2xl mx-auto">
            Ready to make Harjas Hostel your home? Reach out and we&apos;ll get back to you within hours.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="name" className="block text-white/70 text-sm mb-2 font-medium">Full Name</label>
              ...
              <div>
                <label htmlFor="phone" className="block text-white/70 text-sm mb-2 font-medium">Phone Number</label>
              ...
              <div>
                <label htmlFor="email" className="block text-white/70 text-sm mb-2 font-medium">Email Address</label>
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="hostelPreference" className="block text-white/70 text-sm mb-2 font-medium">Hostel Preference</label>
                  <select id="hostelPreference" name="hostelPreference" value={formData.hostelPreference} onChange={handleChange} required
                    ...
                    <option value="" className="bg-teal-primary">Select</option>
                    <option value="boys" className="bg-teal-primary">Boys Hostel</option>
                    <option value="girls" className="bg-teal-primary">Girls Hostel</option>
                  </select>
                </div>
                <div>
                  <label htmlFor="roomType" className="block text-white/70 text-sm mb-2 font-medium">Room Type</label>
                  <select id="roomType" name="roomType" value={formData.roomType} onChange={handleChange} required
                    className="w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white focus:border-gold/50 focus:ring-1 focus:ring-gold/30 focus:outline-none transition-all duration-300 appearance-none cursor-pointer">
                    <option value="" className="bg-teal-primary">Select</option>
                    <option value="single" className="bg-teal-primary">Single Occupancy</option>
                    <option value="twin" className="bg-teal-primary">Twin Sharing</option>
                    <option value="triple" className="bg-teal-primary">Triple Sharing</option>
                  </select>
                </div>
              </div>
              ...
              <motion.button
                ...
                disabled={submitted}
              >
                {submitted ? <>✓ Request Sent Successfully!</> : <><Send size={18} />Request a Callback</>}
              </motion.button>
            </form>
          </motion.div>
          ...
          >
              ...
              {[
                ...
                <div key={title} className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-white/50 text-sm leading-relaxed whitespace-pre-line">{text}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="rounded-xl overflow-hidden border border-white/10 h-64 lg:h-72">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3443.2!2d78.07!3d30.37!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sNear%20UPES%20Bidholi%20Dehradun!5e0!3m2!1sen!2sin!4v1"
